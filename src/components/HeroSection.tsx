...
export function HeroSection() {
  return <section className="relative min-h-screen w-full bg-navy overflow-hidden flex flex-col items-center justify-center pt-20 pb-16 px-4 bg-noise">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col items-center text-center">
        ...
        {/* Rocket Illustration */}
        <motion.div className="relative w-64 h-64 md:w-96 md:h-96 mb-12" animate={{
        y: [-10, 10, -10]
      }} transition={{
        duration: 6,
        repeat: Infinity,
        ease: 'easeInOut'
          ...
          <img src="/image-removebg-preview_%281%29_3.png" alt="Project Haven Rocket" className="w-full h-full object-contain drop-shadow-2xl" />
        </motion.div>
